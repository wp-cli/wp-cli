...
Utils\require_if_exists( ABSPATH . WPINC . '/class-wp-oembed.php', 'WP_oEmbed' );
Utils\require_if_exists( ABSPATH . WPINC . '/class-wp-oembed-controller.php', 'WP_oEmbed_Controller' );
