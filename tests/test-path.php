...
class PathTest extends \PHPUnit_Framework_TestCase {
	...
	public function provideGetDirectoryTests() {
		return array(
			...
			array(
				'phar://C:/webmozart/puli/style.css',
				'phar://C:/webmozart/puli',
			),
	...
	public function testGetFilenameWithoutExtension( $path, $extension, $filename ) {
		$this->assertSame( $filename,
			Path::get_filename_without_extension( $path, $extension ) );
	}
	...
	/**
	 * @expectedException \InvalidArgumentException
	 * @expectedExceptionMessage The extension must be a string or null. Got:
	 *                           array
	 */
	...
	public function testGetExtension( $path, $forceLowerCase, $extension ) {
		$this->assertSame( $extension,
			Path::get_extension( $path, $forceLowerCase ) );
	}
	...
	public function testHasExtension( $hasExtension, $path, $extension, $ignoreCase ) {
		$this->assertSame( $hasExtension,
			Path::has_extension( $path, $extension, $ignoreCase ) );
	}
	...
	public function provideChangeExtensionTests() {
		return array(
			array(
				'/webmozart/puli/style.css.twig',
				'html',
				'/webmozart/puli/style.css.html',
			),
			array(
				'/webmozart/puli/style.css',
				'sass',
				'/webmozart/puli/style.sass',
			),
			array(
				'/webmozart/puli/style.css',
				'.sass',
	...
	public function testChangeExtension( $path, $extension, $pathExpected ) {
		static $call = 0;
		$this->assertSame( $pathExpected,
			Path::change_extension( $path, $extension ) );
		++ $call;
	}
	...
	public function testMakeAbsolute( $relativePath, $basePath, $absolutePath ) {
		$this->assertSame( $absolutePath,
			Path::make_absolute( $relativePath, $basePath ) );
	}
	...
	/**
	 * @expectedException \InvalidArgumentException
	 * @expectedExceptionMessage The base path "webmozart/puli" is not an
	 *                           absolute path.
	 */
	...
	public function testMakeAbsoluteDoesNotFailIfDifferentRoot( $basePath, $absolutePath ) {
		...
		$this->assertSame( Path::canonicalize( $absolutePath ),
			Path::make_absolute( $absolutePath, $basePath ) );
	}
	...
	public function provideMakeRelativeTests() {
		...
		return array_merge( $paths, array(
			...
			array(
				'C:/webmozart/puli/css/style.css',
				'C:/webmozart/puli',
				'css/style.css',
			),
			array(
			...
			array(
				'phar:///webmozart/puli/css/style.css',
				'phar:///webmozart/puli',
				'css/style.css',
			),
			array(
				'phar:///webmozart/css/style.css',
				'phar:///webmozart/puli',
				'../css/style.css',
			),
			array(
			...
			array(
				'phar://C:/webmozart/puli/css/style.css',
				'phar://C:/webmozart/puli',
				'css/style.css',
			),
			array(
				'phar://C:/webmozart/css/style.css',
				'phar://C:/webmozart/puli',
				'../css/style.css',
			),
			array(
	...
	/**
	 * @expectedException \InvalidArgumentException
	 * @expectedExceptionMessage The absolute path
	 *                           "/webmozart/puli/css/style.css" cannot be made
	 *                           relative to the relative path
	 *                           "webmozart/puli". You should provide an
	 *                           absolute base path instead.
	 */
	 ...
	 * @expectedExceptionMessage The absolute path
	 *                           "/webmozart/puli/css/style.css" cannot be made
	 *                           relative to the relative path "". You should
	 *                           provide an absolute base path instead.
	 */
	...
	public function provideGetLongestCommonBasePathTests() {
		return array(
			...
			array(
				array( 'C:\\base\\path', 'C:\\base\\path' ),
				'C:/base/path',
			),
			array( array( 'C:/base/path', 'C:\\base\\path' ), 'C:/base/path' ),
			array(
				array( 'phar:///base/path', 'phar:///base/path' ),
				'phar:///base/path',
			),
			array(
				array( 'phar://C:/base/path', 'phar://C:/base/path' ),
				'phar://C:/base/path',
			),
			...
			array(
				array( 'C:/base/path/sub', 'C:/base/path' ),
				'C:/base/path',
			),
			array(
				array( 'C:\\base\\path\\sub', 'C:\\base\\path' ),
			...
			array(
				array( 'phar:///base/path/sub', 'phar:///base/path' ),
				'phar:///base/path',
			),
			array(
				array( 'phar://C:/base/path/sub', 'phar://C:/base/path' ),
				'phar://C:/base/path',
			),
			...
			array(
				array( 'C:/base/path', 'C:/base/path/sub' ),
				'C:/base/path',
			),
			array(
				array( 'C:\\base\\path', 'C:\\base\\path\\sub' ),
			...
			array(
				array( 'phar:///base/path', 'phar:///base/path/sub' ),
				'phar:///base/path',
			),
			array(
				array( 'phar://C:/base/path', 'phar://C:/base/path/sub' ),
				'phar://C:/base/path',
			),
			...
			array(
				array( 'C:/base/path/di', 'C:/base/path/dir' ),
				'C:/base/path',
			),
			array(
				array( 'C:\\base\\path\\di', 'C:\\base\\path\\dir' ),
			...
			array(
				array( 'phar:///base/path/di', 'phar:///base/path/dir' ),
				'phar:///base/path',
			),
			array(
				array( 'phar://C:/base/path/di', 'phar://C:/base/path/dir' ),
				'phar://C:/base/path',
			),
			...
			array(
				array( 'C:/base/path/dir', 'C:/base/path/di' ),
				'C:/base/path',
			),
			array(
				array( 'C:\\base\\path\\dir', 'C:\\base\\path\\di' ),
			...
			array(
				array( 'phar:///base/path/dir', 'phar:///base/path/di' ),
				'phar:///base/path',
			),
			array(
				array( 'phar://C:/base/path/dir', 'phar://C:/base/path/di' ),
				'phar://C:/base/path',
			),
			...
			array(
				array( 'phar://C:/first', 'phar://C:/second' ),
				'phar://C:/',
			),
			...
			array( array( 'C:\\base\\path', 'D:\\base\\path' ), null ),
			array(
				array( 'phar://C:/base/path', 'phar://D:/base/path' ),
				null,
			),

			// three paths
			array(
				array( '/base/path/foo', '/base/path', '/base/path/bar' ),
				'/base/path',
			),
			array(
				array(
			...
			array(
				array(
					'phar://C:/base/path/foo',
					'phar://C:/base/path',
					'phar://C:/base/path/bar',
				),
				'phar://C:/base/path',
			),
			...
			array(
				array( 'C:/base/path/foo', 'C:/', 'C:/base/path/bar' ),
				'C:/',
			),
			array(
				array(
			...
			array(
				array( '/base/path/foo', 'C:/base/path', '/base/path/bar' ),
				null,
			),
			array(
				array(
	...
	public function testGetLongestCommonBasePath( array $paths, $basePath ) {
		$this->assertSame( $basePath,
			Path::get_longest_common_base_path( $paths ) );
	}
	...
	public function testJoinVarArgs() {
		...
		$this->assertSame( '/path/to/test',
			Path::join( '/path', 'to', '/test' ) );
		$this->assertSame( '/path/to/test/subdir',
			Path::join( '/path', 'to', '/test', 'subdir/' ) );
	}
	 ...
	 * @expectedExceptionMessage Your environment or operation system isn't
	 *                           supported
	 */
